...
export default function EditRecipePage() {
  ...
  async function submit() {
    ...
    if (!id) return setErr("Neispravan ID recepta.");
      ...
      <div className="mt-6 grid gap-4">
        ...
        <div className="grid gap-1">
          <label htmlFor="stepsText" className="text-sm font-medium">
            Koraci pripreme * (jedan po liniji)
          </label>
          <textarea
            id="stepsText"
            className="rounded-md border px-3 py-2"
        ...
        <div className="grid gap-1">
          <label htmlFor="ingredientsText" className="text-sm font-medium">
            Sastojci * (ingredientId | qty | unit)
          </label>
          <textarea
            id="ingredientsText"
            className="rounded-md border px-3 py-2"
